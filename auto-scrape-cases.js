...
`;
    ...
    fs.writeFileSync(path.join(__dirname, 'monitor-scrape.js'), monitorScript);
    console.log('监控脚本已创建: monitor-scrape.js');
}

// 主函数
async function main() {
    console.log('失踪人口案件自动抓取工具');
    console.log('========================\n');
    ...
    console.log('\n使用说明:');
    console.log('- 运行 "node monitor-scrape.js" 来监控抓取进度');
